...
openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoBLHToXYZ(double lat,double lon, double alt)
{
    ...
    return openMVG::Vec3(dX,dY,dZ);
}
openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoXYZToBLH(double x,double y,double z)
{
    double dB0 = 0;
    double dB1 = 0;
    double dThreshold = 0;
    ...
    return openMVG::Vec3(dB,dL,dH);
}

openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoLatLonToXYZ(double lat,double lon,double alt)
{
    ...
    return openMVG::Vec3(x, y, z);
}
openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoLatLonToUTM(double lat,double lon,double alt)
{
    double a = WGS84_A;
    double b = WGS84_B;
...
openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoXYZToLatLon(double x,double y,double z)
{
    ...
    return openMVG::Vec3(openMVG::R2D(lat), openMVG::R2D(lon), alt);
}

//web Mector
openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoUTMToLatLonWMT(double x,double y,double z)
{
...
openMVG::Vec3 UAVProcessGeometry::UAVProcessGeoLatLonToUTMWMT(double lat,double lon,double alt)
{
...
//GCJ01
bool UAVProcessGeometry::OutOfChina(double lat, double lon)
{
...
void UAVProcessGeometry::UAVProcessGeoWGSLatLonToGCJ(double wgLon,double wgLat,double &mgLon,double &mgLat)
{
